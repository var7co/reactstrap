...
var propTypes = {
  ...
  menuClickTarget: _utils.targetPropType
};
var defaultProps = {
  isOpen: false,
  direction: 'down',
...
function (_React$Component) {
  ...
  _proto.getContainer = function getContainer() {
    if (this.props.menuClickTarget) {
      return (0, _utils.getTarget)(this.props.menuClickTarget);
    }
  ...
  _proto.render = function render() {
    ...
    var _omit = (0, _utils.omit)(this.props, ['toggle', 'disabled', 'inNavbar', 'menuClickTarget']),
